...
export const navigation: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'CI Required Checks', href: '/docs/ci_required_checks' },
      { label: 'CI Permissions Model', href: '/docs/ci_permissions_model' },
      { label: 'CI Cache Strategy', href: '/docs/ci_cache_strategy' },
      { label: 'CodeQL Triage', href: '/docs/security/codeql_triage' },
